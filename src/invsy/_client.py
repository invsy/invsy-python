...
class Invsy(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous invsy client instance."""
        if base_url is None:
            base_url = os.environ.get("INVSY_BASE_URL")
        if base_url is None:
...
class AsyncInvsy(AsyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async invsy client instance."""
        if base_url is None:
            base_url = os.environ.get("INVSY_BASE_URL")
        if base_url is None:
            base_url = f"https://localhost:8080/test-api"
